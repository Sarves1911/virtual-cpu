...
int main()
{
    ...
    if (!infile)
    {
        std::cerr << "FATAL ERROR: Could not find or open 'program.asm' in this directory!" << std::endl;
    ...
    std::cout << "Assembler: Successfully compiled program.asm to machine_code.bin" << std::endl;
    return 0;
}